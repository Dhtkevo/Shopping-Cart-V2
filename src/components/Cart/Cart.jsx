    ...
    return (
        <>
            ...
            <div className='pt-6 h-full w-full flex justify-around bg-slate-200 '>
                ...
                {count <= 0 ? <div className="flex flex-col items-center justify-center w-1/2 h-1/2 mt-8 rounded-xl shadow-sm shadow-black gap-28 bg-slate-50">
                    ...
                    <>
                        ...
                        <div className="shadow-lg shadow-slate-200 flex flex-col justify-around items-center w-1/3 h-1/2 gap-14 bg-white rounded-xl">
                            ...
                            <NavLink to="/">
                                <button onClick={() => dispatch(clearCart())} className="bg-green-400 text-white p-2 rounded-xl hover:shadow-md hover:shadow-green-300e" type="button">Proceed to checkout</button>
                            </NavLink>
